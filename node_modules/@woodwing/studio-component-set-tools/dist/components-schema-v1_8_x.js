...
exports.componentsDefinitionSchema_v1_8_x = void 0;
const defaultValue = {
...
function labelProperty(description) {
    return {
        oneOf: [
            {
                type: 'string',
...
function inlineComponentPropertyDefinitionOrReferenceList(isChildProperty) {
    return {
        oneOf: [
            {
                type: 'string',
            },
            {
                type: 'object',
                additionalProperties: false,
                anyOf: [{ required: ['name', 'directiveKey'] }].concat(!isChildProperty ? [{ required: ['name', 'defaultValue'] }] : []),
                properties: {
                    name: {
                        type: 'string',
...
exports.componentsDefinitionSchema_v1_8_x = {
    ...
    properties: {
        ...
        components: {
            ...
            items: {
                ...
                properties: {
                    ...
                    showToolbar: {
                        enum: ['default', 'always'],
                        description: 'When to show the toolbar. By default only show on hovering the mouse on the component. Use the "always" option to show the toolbar in all cases.',
                    },
                    allowNesting: {
        ...
        customStyles: {
            type: 'array',
            description: 'List of custom styles definitions which can be configured in the look and feel style of an article',
            items: {
                type: 'object',
                properties: {
...
//# sourceMappingURL=components-schema-v1_8_x.js.map