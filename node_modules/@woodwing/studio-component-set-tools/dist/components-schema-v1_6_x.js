...
exports.componentsDefinitionSchema_v1_6_x = void 0;
/* tslint:disable:max-line-length variable-name */
const labelProperty = (description) => {
    return {
        oneOf: [
            {
                type: 'string',
...
exports.componentsDefinitionSchema_v1_6_x = {
    type: 'object',
    properties: {
        name: {
            type: 'string',
...
//# sourceMappingURL=components-schema-v1_6_x.js.map