...
export declare enum ComponentRendition {
    HTML = "html",
    PSV = "psv"
}
export interface ComponentProperty<ControlType = ComponentPropertyControl> {
    ...
    dataType: 'styles' | 'inlineStyles' | 'data' | 'doc-editable' | 'doc-image' | 'doc-html' | 'doc-slideshow' | 'doc-media' | 'doc-interactive' | 'doc-link';
